    ...
    <div class="layui-layout layui-layout-admin">
          ...
          <li class="layui-nav-item" lay-unselect>
            ...
            <dl class="layui-nav-child" style="padding: 0;">
              <div class="admin-idcard">
                ...
                <p>{{ $admin->nickname }}</p>
                <span>管理组:{{ $admin->rolename }}</span>
                <a class="left">个人中心</a>
                <a class="right" id="logout">登出</a>
              </div>
            </dl>
          </li>
        </ul>
      ...
      <div class="layadmin-pagetabs" id="LAY_app_tabs">
          ...
          <ul class="layui-nav layadmin-tabs-select" lay-filter="layadmin-pagetabs-nav">
            <li class="layui-nav-item" lay-unselect>
              ...
              <dl class="layui-nav-child layui-anim-fadein">
                <dd id="closeThisTabs" layadmin-event="closeThisTabs"><a href="javascript:;">关闭当前标签页</a></dd>
        ...
        <div class="layui-tab" lay-unauto lay-allowClose="true" lay-filter="layadmin-layout-tabs">
          <ul class="layui-tab-title" id="LAY_app_tabsheader">
            <li lay-id="{{ env('ADMIN_PREFIX', 'admin') }}/workbench" lay-attr="{{ env('ADMIN_PREFIX', 'admin') }}/workbench" class="layui-this"><i class="layui-icon layui-icon-home"></i></li>
          </ul>
        </div>
      </div>
      ...
      <div class="layui-body" id="LAY_app_body">
        <div class="layadmin-tabsbody-item layui-show">
          <iframe src="{{ env('ADMIN_PREFIX', 'admin') }}/workbench" frameborder="0" class="layadmin-iframe"></iframe>
        </div>
      </div>
